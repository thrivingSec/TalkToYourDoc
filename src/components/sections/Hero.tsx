...
const Hero = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full min-h-screen gap-6 overflow-hidden mt-30">
      ...
      {/* text */}
      <div className="mx-auto w-full max-w-5xl px-6 py-10 flex flex-col items-center gap-6" id="hero">
        <h1 className="text-4xl lg:text-7xl font-semibold text-center tracking-tight bg-clip-text text-transparent bg-linear-to-br from-primary via-accent to-secondary">
          {md.hero.title}
        </h1>

        <h2 className="text-xl lg:text-3xl font-semibold text-center leading-tight text-muted-foreground">
          {md.hero.subtitle}
        </h2>
      ...
      {/* image */}
      <div className="mx-auto w-[90%] max-w-7xl mt-10 relative ">
